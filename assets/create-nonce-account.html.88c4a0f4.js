import{_ as n,e as s}from"./app.1f6edd2c.js";const a={},t=s(`<h1 id="create-nonce-account" tabindex="-1"><a class="header-anchor" href="#create-nonce-account" aria-hidden="true">#</a> Create Nonce Account</h1><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
